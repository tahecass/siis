...
/**
 * @author msuevis
 * @name TreeItemRenderFondoMovimiento.java
 * @date 24/05/2011
 * @desc
 */

public class TreeItemRenderMovimiento implements TreeitemRenderer<Object>{

	protected static Logger log = Logger.getLogger(TreeItemRenderMovimiento.class);

	public TreeItemRenderMovimiento() {
